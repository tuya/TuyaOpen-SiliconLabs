...
//  <i> Enable: Peripheral configuration is taken straight from the configuration set in the universal configuration
//  (UC). <i> Disable: If the application demands it to be modified during runtime, use the
//  sl_si91x_i2s_config_transmit_receive API to modify the peripheral configuration. <i> Default: 0
#define I2S0_UC 0
...
#define SL_I2S0_DOUT0_PIN 11
#endif
#ifndef SL_I2S0_DOUT0_LOC
#define SL_I2S0_DOUT0_LOC 8
#endif
