...
#define DWORD_SWAP(X) ((((X)&0xff) << 24) + (((X)&0xff00) << 8) + (((X)&0xff0000) >> 8) + (((X)&0xff000000) >> 24))
...
#ifndef TUYA_UNUSED
#define TUYA_UNUSED(x) (void)(x)
#endif

#ifndef TKL_UNUSED
#define TKL_UNUSED(x) (void)(x)
#endif
...
/****** QSPI Event *****/
typedef enum {
    TUYA_QSPI_EVENT_TX = 0, ///< Data Transfer completed. tkl_spi_transfer to indicate that all the data has been
                            ///< transferred. The driver is ready for the next transfer operation
    TUYA_QSPI_EVENT_RX, ///< Data Transfer completed. Occurs after call tkl_spi_receive to indicate that all the data
                        ///< has been transferred. The driver is ready for the next transfer operation
} TUYA_QSPI_IRQ_EVT_E;
...
typedef enum { TUYA_NETIF_STA_IDX = 0, TUYA_NETIF_AP_IDX, TUYA_NETIF_ETH_IDX, TUYA_NETIF_NUM } TUYA_NETIF_TYPE_E;
